function varargout=shadedErrorBarForAxes(axH, x,y,errBar,lineProps,transparent)
% function H=shadedErrorBar(axH, x,y,errBar,lineProps,transparent)
%
% Purpose 
...
H.mainLine=plot(axH, x,y,lineProps{:});
